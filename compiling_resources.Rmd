...
The [third edition of the ggplot2 book](https://ggplot2-book.org/scales-colour#sec-legend-layout) helped me discover how to stack the horizonal guide legends using legend.box within theme().
