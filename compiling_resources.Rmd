...
["#77c1ad", "#156b55", "#a5e672", "#59a20c", "#39f27a", "#33547a"]

["#77c1ad", "#115e41", "#90ea66", "#781486", "#bbc3fe", "#3c4666"]

["#77c1ad", "#0b522e", "#47f0a3", "#0362a0", "#afe642", "#6146ca"]

["#77c1ad", "#2a6866", "#55f17b", "#238910", "#a5d65a", "#6a7f2f"]

["#77c1ad", "#115d52", "#9ae871", "#54a32f"]
...
See [Chapter 10.1.1](https://mastering-shiny.org/action-dynamic.html?#simple-uses) for easy instructions for creating a reset button using actionButton(). See {shiny} documentation for updateSelectInput() choices to use to clear selections.
